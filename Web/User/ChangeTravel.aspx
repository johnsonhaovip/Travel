<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="ChangeTravel.aspx.cs" Inherits="User_ChangeTravel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
        ...
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1"
            ...
            <ItemTemplate>
                <div class="mycontent1">
                    旅行名称:<asp:TextBox ID="title" runat="server" Text='<%# Eval("t_title") %>' />
                </div>

                <div class="mycontent1">
                    出发地:<asp:TextBox ID="t_depart" runat="server" Text='<%# Eval("t_depart") %>' />

                </div>

                <div class="mycontent1">
                    目的地:
                    <asp:TextBox ID="t_destination" runat="server" Text='<%# Eval("t_destination") %>' />

                </div>

                <div class="mycontent1">
                    出发时间:<asp:TextBox ID="t_startTime" runat="server" Text='<%# ((DateTime)Eval("t_startTime")).ToString("yyyy-MM-dd") %>' />
                </div>

                <div class="mycontent1">
                    旅行天数:<asp:TextBox ID="t_sumTime" runat="server" Text='<%# Eval("t_sumTime") %>' />
                    <asp:Button ID="tijiao" runat="server" Text="确定修改" CommandName="tijiao" />
                </div>
            </ItemTemplate>
        </asp:DataList>
    </div>
    ...
    <div id="MyTravel_content">
        <div id="search-box">
            ...
            <asp:Button ID="btn_search" runat="server" OnClientClick="initialize()" Text="搜索" Width="50px" Height="45px" />
        </div>
